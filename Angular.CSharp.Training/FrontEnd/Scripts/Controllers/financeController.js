app.controller('FinanceController', ['$scope', 'EmployeeService', function ($scope, EmployeeService) {
    ...
    $scope.loadEmployees = function () {
        EmployeeService.getAllEmployees().then(function (response) {
            ...
            $scope.filteredEmployees = $scope.employees.filter(emp => emp.EmpDeptName === 'Finance');
